<template>
  <div class="md:py-[48px] md:px-[96px] s:py-[33px] s:px-[25px]">
    ...
    >
      ...
      <ul
        class="flex items-center lg:gap-[53px] md:gap-[38px] s:hidden md:flex"
      >
        <li>
          <a
      ...
      >
        ...
        <button
          class="bg-purple py-[17px] px-[26px] rounded-[17px] hover:bg-opacity-75"
        >
          <a
      ...
      <button
        ...
        class="s:block md:hidden s:w-[31px] s:h-[18px]"
      >
