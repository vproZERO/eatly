<template>
    <div class="flex  justify-between     ">
        <div class="md:px-[96px] md:py-[48px] s:py-[31px] s:px-[25px] md:w-[880px] xs:w-[450px]  s:w-[320px] s:mx-auto   sm:mx-0">
            <div class="flex items-center justify-between s:border-b-2 border-lightgray sm:border-b-0 s:mb-[100px] sm:mb-0">
                <a class="block md:w-[46px] md:h-[42px]  sm:w-[37px] sm:h-[34px]  s:w-[45px] s:h-[42px]    md:mb-[172px] sm:mb-[130px]   s:mb-[30px]     " href="#/home">
                    <img src="../assets/logo.png" alt="logo">
                </a>
                <button v-on:click="isOpen = !isOpen" class="s:block sm:hidden s:w-[31px] s:h-[18px]">
      ...
      >
        ...
        >
          ...
          <div class="">
            ...
            <button class="bg-purple md:py-[17px] md:px-[26px] rounded-[17px] block mx-auto w-full s:px-[10px] s:py-[10px]">
              <a
            ...
            <p class="mb-3 capitalize text-center lg:w-[289px] mx-auto lg:text-[35px] lg:leading-[44px] font-semibold   xs:w-[218px] xs:text-[25px] xs:leading-[31px]">Sign Up To eatly</p>
...
<input class="bg-inherit" type="text" placeholder="Full Name">
...
<div class="s:w-[271px] lg:w-[382px] mx-auto text-center mb-10">
        <p >Already Have An Account? <a class="text-purple" href="#/signin">Log In</a></p>
</div>
        </div>
        ...
        <div class=" bg-purple  lg:w-[663px] md:pt-[70px] md:pl-[78px] md:pr-[39px] md:pb-[58px]   sm:w-[471px] s:hidden sm:block">
            <div>
                <img src="../assets/biggroup.png" alt="big img group">
            </div>
            <h3 class="lg:text-[40px] lg:leading-[44px] text-white text-center font-extrabold  sm:text-[28px] sm:leading-[31px] mb-5">Find Foods With Love </h3>
            <p class="text-center text-white font-normal lg:text-[14px] lg:leading-[21px]   sm:text-[9px] sm:leading-[14px]  sm:w-[355px] mx-auto">Eatly Is The Food Delivery Dashboard And Having More Than 2K+ Dishes Including Asian, Chinese, Italians And Many More. Our Dashboard Helps You To Manage Orders And Money.</p>
        </div>
    </div>
</template>
<script>
